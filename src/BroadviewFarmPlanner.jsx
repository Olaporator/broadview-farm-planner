...
const PLOTS = [
  ...
  { id: "h3c", area: "h3", name: "Tomato, Basil & Outdoor Peppers", type: "Raised Bed", sqft: 60, status: "Active", color: C.spring },
  { id: "h3f", area: "h3", name: "Perennial Herb & Berry Bed", type: "Raised Bed", sqft: 30, status: "Active", color: C.spring },
  { id: "h3g", area: "h3", name: "Arugula & Strawberry Planter (#9)", type: "Raised Bed", sqft: 15, status: "Active", color: C.spring },
  { id: "h3d", area: "h3", name: "Allium & Mustard Mound", type: "In-Ground (Mounded 4-6\")", sqft: 100, status: "Active", color: C.soil },
  ...
  { id: "h4d", area: "h4", name: "Aromatic Rodent-Defense Bed", type: "Raised Bed", sqft: 20, status: "Active", color: C.raisedBed },
  ...
  { id: "h6b", area: "h6", name: "Indoor Herbs & Peppers", type: "Indoor", sqft: 10, status: "Active", color: C.greenhouse },
...
const PLANTS = [
  ...
  { id: "cayenne_pepper", name: "Cayenne Pepper", plot: "h3c", type: "Annual", count: "1-2 plants",
    maintenance: [
      { season: "Spring", action: "Sow", notes: "Start indoors Feb-Mar; transplant after frost." },
      { season: "Summer", action: "Water", notes: "Consistent moisture; mulch base." },
      { season: "Summer", action: "Harvest", notes: "Pick red peppers for fresh or drying." },
    ]},
  { id: "jalapeno_pepper", name: "Jalapeño Pepper", plot: "h3c", type: "Annual", count: "1-2 plants",
    maintenance: [
      { season: "Spring", action: "Sow", notes: "Start indoors Feb-Mar; transplant after frost." },
      { season: "Summer", action: "Water", notes: "Consistent moisture during fruiting." },
      { season: "Summer", action: "Harvest", notes: "Pick green or red; use fresh or preserve." },
    ]},
  { id: "sage", name: "Sage (2yr established)", plot: "h3f", type: "Perennial Herb", count: "2 plants",
    maintenance: [
      { season: "Spring", action: "Prune", notes: "Cut back 1/3 after winter. 2yr established — well-rooted. Slug deterrent for strawberries." },
      { season: "Summer", action: "Harvest", notes: "Pinch leaves for culinary use." },
    ]},
  { id: "oregano_h3f", name: "Oregano (Mediterranean companion)", plot: "h3f", type: "Perennial Herb", count: "2-3 plants",
    maintenance: [
      { season: "Spring", action: "Prune", notes: "Cut back to encourage fresh growth. Ground cover, spreads gently." },
      { season: "Summer", action: "Harvest", notes: "Pinch regularly for cooking; flowers attract parasitic wasps." },
    ]},
  { id: "strawberries_h3f", name: "Strawberries (ground layer)", plot: "h3f", type: "Perennial", count: "6-8 plants",
    maintenance: [
      { season: "Spring", action: "Nutrient", notes: "Top-dress with compost. Sage canopy repels slugs—natural pest defense." },
  ...
  { id: "onion_h3d", name: "Onion (long-day PNW variety)", plot: "h3d", type: "Annual", count: "~40 sets",
    maintenance: [
      { season: "Spring", action: "Sow", notes: "Plant sets Mar-Apr, 4-6\" apart in mounded soil." },
      { season: "Summer", action: "Water", notes: "Consistent moisture during bulb formation." },
      { season: "Summer", action: "Harvest", notes: "Harvest Jul-Aug when tops fall over. Cure 2-3 weeks." },
    ]},
  { id: "brown_mustard_h3d", name: "Brown Mustard (biofumigation)", plot: "h3d", type: "Annual", count: "~30 plants",
    maintenance: [
      { season: "Spring", action: "Sow", notes: "Succession sow Mar-Sep. Direct seed 6\" apart." },
      { season: "Summer", action: "Harvest", notes: "Cut and drop as green manure before flowering. Biofumigation repels pests." },
      { season: "Fall", action: "Harvest", notes: "Final cut before freeze. Buckwheat volunteers self-seed as living mulch." },
    ]},
  { id: "regular_mustard_h3d", name: "Regular Mustard (salad green)", plot: "h3d", type: "Annual", count: "~20 plants",
    maintenance: [
      { season: "Spring", action: "Sow", notes: "Direct sow Mar-Sep, thin to 3-4\" apart." },
      { season: "Spring", action: "Harvest", notes: "Pick young leaves for spicy salad green." },
      { season: "Summer", action: "Harvest", notes: "Cut-and-come-again until bolting in peak heat." },
    ]},
  ...
  { id: "shiso_h4d", name: "Shiso / Perilla (Japanese aromatic)", plot: "h4d", type: "Annual/Perennial", count: "2-3 plants",
    maintenance: [
      { season: "Spring", action: "Sow", notes: "Start indoors or direct sow after frost. Self-seeds vigorously." },
      { season: "Summer", action: "Harvest", notes: "Pinch leaves for Japanese cuisine; anise-mint aroma rodent deterrent." },
      { season: "Fall", action: "Harvest", notes: "Shiso self-seeds. Allows volunteers as living pest barrier." },
    ]},
  { id: "garlic_chives_h4d", name: "Garlic Chives (perennial allium barrier)", plot: "h4d", type: "Perennial", count: "3-4 plants",
    maintenance: [
      { season: "Spring", action: "Prune", notes: "Cut back; spreads via runners. Perennial allium pest barrier—sulfur scent repels rodents." },
      { season: "Summer", action: "Harvest", notes: "Pinch tips for cooking; flowers are edible." },
    ]},
  { id: "lemon_thyme_h4d", name: "Lemon Thyme (citrus-scent deterrent)", plot: "h4d", type: "Perennial Herb", count: "2-3 plants",
    maintenance: [
      { season: "Spring", action: "Prune", notes: "Cut back 1/3; ground cover spreads slowly. Triple-scent defense: mint/anise + sulfur + citrus." },
      { season: "Summer", action: "Harvest", notes: "Pinch for culinary use and tea. Citrus aroma complements rodent navigation suppression." },
    ]},
  ...
  { id: "basil_indoor", name: "Basil (indoor)", plot: "h6b", type: "Annual Herb", count: "1 plant (4\" planter)",
    maintenance: [
      { season: "Year-round", action: "Light", notes: "Needs 6-8 hrs light; supplement with grow light in winter. Southeast Asian pairing with Thai chili." },
      { season: "Year-round", action: "Harvest", notes: "Pinch tips regularly to prevent bolting." },
    ]},
  { id: "thai_chili_pepper", name: "Thai Chili Pepper (indoor compact)", plot: "h6b", type: "Annual", count: "1-2 plants",
    maintenance: [
      { season: "Year-round", action: "Light", notes: "Needs 12-14 hrs grow-light daily. Compact variety for indoor space." },
      { season: "Year-round", action: "Water", notes: "Keep soil evenly moist; good drainage essential." },
      { season: "Year-round", action: "Harvest", notes: "Pick green or red peppers continuously for fresh use or preserving." },
    ]},
  // ── H6c — North Indoor ──
